...
function ProfileButton({ name }: { name: string }) {
  return (
    <div className="flex w-full items-center  rounded px-2.5 py-1.5 hover:bg-gray-100 focus:outline-none">
      ...
      <div className="50 pl-3">
        <ChevronUpIcon className="h-3.5 w-3.5 text-gray-700"></ChevronUpIcon>
      </div>
    </div>
  )
}
...
function Menu({
  ...
  return (
    ...
    >
      {isActive ? (
        <div className="absolute left-0 top-0 h-full w-[3px] bg-primary-500"></div>
      ) : null}
